...
const AboutBusiness = () => {
  return (
    <div className="bg-[#F4FAFF] min-h-screen">
      <Navbar />
      <SEO
        title="About SS Surveillance | CCTV Company in Surat"
        description="Trusted CCTV company in Surat with 6+ years experience serving banks, offices and businesses."
        keywords="CCTV company Surat, surveillance services Surat"
      />
      {/* 🔥 HERO (Light Glassy) */}
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-blue-600 font-semibold mb-4">Founder & Owner</p>

            <p className="text-slate-600 mb-4 leading-relaxed">
              SS Surveillance over 6 years experience in the security and
              surveillance industry, and company goal has always been to provide
              reliable and effective solutions to protect homes and businesses.
            </p>

            <p className="text-slate-600 mb-6 leading-relaxed">
              SS Surveillance specialize in CCTV installation, DVR/NVR setup,
              fire alarm systems, intrusion detection, and biometric security
              solutions. company personally ensure that every project is
              completed with quality, precision, and complete customer
              satisfaction.
            </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
          {/* Mission */}
          <div
            className="group relative bg-gradient-to-br from-blue-50 to-white 
    p-8 rounded-3xl shadow hover:shadow-2xl transition overflow-hidden"
          >
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              solutions tailored to each client’s needs. We focus on
              reliability, precision installation, and long-term customer
              satisfaction.
            </p>
          </div>
    ...
    p-8 rounded-3xl shadow hover:shadow-2xl transition overflow-hidden"
          >
            ...
            <p className="text-slate-600 leading-relaxed">
              To become one of Gujarat’s most trusted security solution
              providers by continuously innovating and offering advanced, smart,
              and scalable protection systems.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-gradient-to-b from-white to-blue-50">
        ...
        <div className="text-center mb-14">
          <h2 className="text-4xl font-bold text-slate-900">Areas We Serve</h2>

          <p className="text-slate-600 max-w-2xl mx-auto mt-3">
            We provide professional CCTV installation and advanced security
            solutions across Gujarat with fast response and trusted service
            support.
          </p>

          <div
            className="mt-4 inline-flex items-center gap-2 px-5 py-2 text-sm 
bg-gradient-to-r from-blue-100 to-blue-50 text-blue-700 rounded-full border font-semibold shadow"
        ...
        bg-blue-200 blur-2xl opacity-30 group-hover:opacity-60 transition"
              ></div>
        ...
        <div className="text-center mt-14">
          <p className="text-sm text-slate-600 leading-relaxed">
            We provide fast installation, reliable support, and secure
