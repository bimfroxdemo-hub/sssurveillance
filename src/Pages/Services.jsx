  ...
  const services = [
    {
      ...
      description: "Complete CCTV solutions with real-time monitoring for homes and businesses.",
      features: ["CCTV camera installation", "DVR / NVR setup", "Remote monitoring", "Maintenance & repair"],
      img: cctv,
    },
    {
      icon: Flame,
      title: "Fire Alarm Systems",
      description: "Advanced fire detection systems to ensure safety and early alerts.",
      features: ["Fire alarm installation", "Fire detection sensors", "Safety alert systems"],
      img: fire,
    },
    {
      icon: ShieldAlert,
      title: "Security Alarm Systems",
      description: "Intrusion detection and emergency alert systems for complete protection.",
    ...
    },
    {
      ...
      description: "Modern access control with biometric and motion-based systems.",
  ...
  const faqs = [
    {
      ...
      answer: "Yes, we offer annual maintenance and repair services for all security systems.",
    },
    {
      question: "Can I monitor my CCTV remotely?",
      answer: "Absolutely, all CCTV systems can be monitored via mobile or desktop apps.",
    },
    {
      question: "Are the fire alarms certified?",
      answer: "Yes, all our fire alarm systems comply with local and international safety standards.",
    },
  ];
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      ...
      <section className="py-20 bg-blue-50">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            ...
            burglar systems and biometric access to keep your home and business safe.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-5 sm:p-6 md:p-7">
                ...
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed mb-3">
                  {s.description} High-quality installation, monitoring systems, and reliable support.
                </p>
      ...
      <section className="py-20 bg-blue-50 text-center">
        <h2 className="text-3xl font-bold text-blue-900 mb-12">Why Choose SS Surveillance?</h2>
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 lg:grid-cols-3 gap-8">
          <div className="p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition">
            ...
            <p className="text-gray-600">Latest CCTV, fire alarms & biometric systems for complete protection.</p>
          </div>
          <div className="p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition">
            <ShieldAlert className="text-blue-600 w-10 h-10 mx-auto mb-4" />
            <h3 className="font-bold text-xl mb-2">Certified Professionals</h3>
            <p className="text-gray-600">Trained, certified & experienced team for installations & maintenance.</p>
          </div>
          <div className="p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition">
            <Flame className="text-blue-600 w-10 h-10 mx-auto mb-4" />
            <h3 className="font-bold text-xl mb-2">24/7 Support</h3>
            <p className="text-gray-600">Round-the-clock support & monitoring for your peace of mind.</p>
          </div>
        </div>
      </section>
